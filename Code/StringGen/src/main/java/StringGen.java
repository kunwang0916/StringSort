 ...
 */
public class StringGen extends Configured implements Tool {
    ...
    static long getNumberOfRows(JobConf job) {
        return job.getLong("stringsort.num-rows", 0);
    }

    static void setNumberOfRows(JobConf job, long numRows) {
        job.setLong("stringsort.num-rows", numRows);
    }
    ...
    public int run(String[] args) throws IOException {
        ...
        job.setJobName("StringGen");
        job.setJarByClass(StringGen.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        int res = ToolRunner.run(conf, new StringGen(), args);
        System.exit(res);
    }
