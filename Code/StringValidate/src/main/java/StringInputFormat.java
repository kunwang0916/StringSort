 ...
 * as Text.
 */
public class StringInputFormat extends FileInputFormat<Text,Text> {

    static final String PARTITION_FILENAME = "_partition.lst";
    static final String SAMPLE_SIZE = "stringsort.partitions.sample";
    ...
    public static void writePartitionFile(JobConf conf,
        ...
        StringInputFormat inFormat = new StringInputFormat();
