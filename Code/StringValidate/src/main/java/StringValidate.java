 ...
 */
public class StringValidate extends Configured implements Tool {
    ...
    public int run(String[] args) throws Exception {
        ...
        job.setJobName("StringValidate");
        job.setJarByClass(StringValidate.class);
    ...
    public static void main(String[] args) throws Exception {
        int res = ToolRunner.run(new JobConf(), new StringValidate(), args);
        System.exit(res);
    }
